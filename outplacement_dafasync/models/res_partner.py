...
class ResPartner(models.Model):
    ...
    def partnersyncCrm2DafaSSN(self,ssn):
        ...
        for job in partner.job_ids:
            job_tuple = (job.ssyk_code,job.experience_length,job.experience,job.education)
            
            if job.education_id:
                job_tuple = job_tuple + (job.education_id.sun_id.code, job.education_id.education_level_id.name, job.education_id.foreign_education, job.education_id.foreign_education_approved)
