...
class Outplacement(models.Model):
    ...
    education_ids = fields.One2many(string="Educations", comodel_name="res.partner.education",
                                    inverse_name="partner_id", related="partner_id.education_ids", readonly=False)
    ...
    has_drivers_license = fields.Boolean(string="Has drivers license",
                                         ...
                                         related="partner_id.has_drivers_license", readonly=False)
